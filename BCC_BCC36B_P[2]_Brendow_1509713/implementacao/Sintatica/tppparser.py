...
def p_declaracao_variaveis_error(p):
    """declaracao_variaveis : tipo error lista_variaveis"""
    global error_code
...
def p_lista_variaveis_error(p):
    """lista_variaveis : lista_variaveis error var
    """
    global error_code

    if error_code ==  1: 
        print("Erro na definicao de lista de variaveis")
        error_code = -1
    p.error()
...
def p_se_error_1(p):
    ...
    if error_code ==  1: 
        print("Erro na definicao do se")
        error_code = -1
    p.error()

def p_se_error_2(p):
    """se : SE expressao error corpo SENAO corpo FIM"""
    global error_code
...
def p_se_error_4(p):
    """se : error expressao ENTAO corpo SENAO corpo FIM"""    
    global error_code
...
def p_se_error_5(p):
    """se : SE expressao ENTAO corpo error corpo FIM"""
    global error_code
...
def p_repita_error_1(p):
    """repita : REPITA corpo error expressao"""
    global error_code
...
def p_cabecalho_error(p):
    ...
    if error_code ==  1: 
        print("Erro na definicao do cabeçalho")
        error_code = -1
    p.error()
...
def p_lista_parametros_error(p):
    ...
    if error_code ==  1: 
        print("Erro na definicao da lista de parametros")
        error_code = -1
    p.error()
